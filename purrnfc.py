...
def hooman(hooman_id: str, xnm='hooman', xyr='2023', xis='losers'):
    ...
    with open("/home/cat/scans.txt", "a+t") as handle:
        handle.write(f"{hooman_id},{xnm},{xyr},{xis}\n")
    play_sound("/butts/wav/mixkit-sound-alert-in-hall-1006.wav")
    play_sound("/butts/wav/trashfence.wav")
